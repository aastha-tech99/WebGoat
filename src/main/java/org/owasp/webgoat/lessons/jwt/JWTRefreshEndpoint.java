...
public class JWTRefreshEndpoint implements AssignmentEndpoint {
  ...
  public static final String PASSWORD = "bm5nhSkxCXZkKRy4"; // WebGoat lesson fixture, not a real credential
  private static final String JWT_PASSWORD = "bm5n3SkxCX4kKRy4"; // WebGoat lesson fixture, not a real credential
  ...
  public ResponseEntity follow(@RequestBody(required = false) Map<String, Object> json) {
    ...
    if ("Jerry".equalsIgnoreCase(user) && PASSWORD.equals(password)) { // WebGoat lesson fixture, not a real secret
