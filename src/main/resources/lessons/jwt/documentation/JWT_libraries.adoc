...
[source]
----
// Example JWT for educational purposes only — not a real credential
...
[source]
----
// Example JWT (alg:none) for educational purposes only — not a real credential
...
[source]
----
// Example JWT (alg:none, no signature) for educational purposes only — not a real credential
