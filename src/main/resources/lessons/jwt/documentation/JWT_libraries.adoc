...
[source]
----
var token = "eyJhbGciOi...<REDACTED>...K7Ng"; // HS256 JWT — see decoded content above
...
[source]
----
var token = "eyJhbGciOi...<REDACTED>...K7Ng"; // same JWT with alg:none header
...
[source]
----
var token = "eyJhbGciOi...<REDACTED>."; // unsigned JWT (no signature, trailing dot)
