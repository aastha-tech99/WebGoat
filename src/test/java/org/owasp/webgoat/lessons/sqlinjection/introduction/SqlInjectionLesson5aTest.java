...
public class SqlInjectionLesson5aTest extends LessonTest {
  ...
  @Test
  public void sqlInjectionPrevented() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/assignment5a")
                .param("account", "'")
        ...
        .andExpect(
            jsonPath(
                "$.feedback", is(messages.getMessage("sql-injection.5a.no.results"))));
  }

  @Test
  public void sqlInjectionAttemptShouldNotReturnResults() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/assignment5a")
                .param("account", "Smith'")
