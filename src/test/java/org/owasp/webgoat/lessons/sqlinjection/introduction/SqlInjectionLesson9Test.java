...
public class SqlInjectionLesson9Test extends LessonTest {
  ...
  @Test
  public void injectionUpdateAttemptIsBlocked() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/attack9")
                .param("name", "Smith")
  ...
  @Test
  public void injectionUpdateAllIsBlocked() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/attack9")
                .param("name", "Smith")
  ...
  @Test
  public void injectionViaNameFieldIsBlocked() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/attack9")
  ...
  @Test
  public void injectionSalaryUpdateIsBlockedByParameterizedQuery() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.post("/SqlInjection/attack9")
                .param("name", "Smith")
